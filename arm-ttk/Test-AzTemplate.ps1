                ...
                if (-not $Pester) {
                    ...
                    $innerGroup = 
                        if ($testCaseOutput.InnerTemplateStart) {
                            $innerTemplateStartIndex = $testCaseOutput | Select-Object -First 1 -ExpandProperty InnerTemplateStart
                            $innerTemplateLength     = $testCaseOutput | Select-Object -First 1 -ExpandProperty InnerTemplateLength
